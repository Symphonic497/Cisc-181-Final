...
public class TestFinance {
	...
	public void TestRetirement() {
		...
		Retirement R2 = new Retirement(iYearsToWork,dAnnualReturnWorking,iYearsRetired,dAnnualReturnRetired,dRequiredIncome,dMonthlySSI);
		System.out.println(R2.TotalAmountToSave());
		System.out.println(R2.MonthlySavings());
	}
	...
	public void TestPMT() {
		...
		double PMT = FinanceLib.pmt(dAnnualReturnWorking/12, iYearsToWork*12, 0, 1454485.55, false);
